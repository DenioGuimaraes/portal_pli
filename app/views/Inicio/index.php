<div class="inicio-pagina-inicio">
  ...
  <div class="inicio-painel-pessoal">
    <!-- Conteúdo lateral -->
  </div>
</div>
    ...
    <div class="resumo-modal-corpo">
      ...
      <div class="resumo-coluna-form">
        ...
        <div class="resumo-campo-form">
          ...
          <input id="resumoCampoTqCarga" max="6616" min="6601" step="1" type="number" />
        </div>
        <div class="resumo-campo-form">
          <label for="resumoCampoTqProduto">TQ de Produto:</label>
          <input id="resumoCampoTqProduto" max="6616" min="6601" step="1" type="number" />
        </div>
        <div class="resumo-campo-form">
